...
function cheatPages(){
  ...
  document.addEventListener('visibilitychange', function() {
    if(document.hidden) {
      $('[rel="icon"]').attr('href', "https://cdn.jsdelivr.net/gh/leafjame/cdn/img/icon/failure.png");
      $('[rel="shortcut icon"]').attr('href', "https://cdn.jsdelivr.net/gh/leafjame/cdn/img/icon/failure.png");
